...
public class LogPanel extends JPanel {
	...
	/**
	 * Das LogPanel ist ein Singleton, daher kann kein Objekt 
	 * direkt angelegt werden.<br>
	 * Die Methode legt ein Objekt des LogPanel an, wenn noch 
	 ...
	 * <br>
	 * 
	 * @param type    the type of the message defined as constants GuiManager<br>
	...
	/**
	 * Simply logs a message adding a time stamp. Type of message will be:<br>
	 * INFO - black - information message<br>
	 * 
	 * @param message the message to be displayed
	 */
	...
	/**
	 * Standardkonstruktor erzeugt ein JPanel, das in einer beliebigen GUI
	 * eingefuegt werden kann Da es sich um ein Singleton handelt, darf der
	 * Konstruktor nicht public sein!
	 */
	private LogPanel() {
		...
		JScrollPane jsp = new JScrollPane(gridBagPanel, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,
	...
	private synchronized void internAddMessage(String type, String message) {
		...
		/*
		 * try { System.setOut(new java.io.PrintStream(System.out, true, "cp850")); }
